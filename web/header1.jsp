	...
	<div class="container">
		...
		<div class="top-nav">
			<ul class="right-icons">
				...
				<li><span ><i class="glyphicon glyphicon-phone"> </i>079-26870096</span></li>
				<li><a  href="validatelogin"><i class="glyphicon glyphicon-user"> </i>
