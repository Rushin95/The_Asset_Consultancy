                    ...
                    <div class="col-md-6 contact-top1">
                        ...
                        <div class="contact-address">
                            ...
                            <div class="col-md-6 contact-address1">
                                ...
                                <p>Rated <% out.println(ad.getARating());%> by 50 users.</p>
                            </div>
                ...
                <div class="dealer-top">
                    ...
                    <%
                        ...
                        if ((request.getAttribute("pdl")) != null) {
                            ArrayList<PropDetail> aa = (ArrayList<PropDetail>) request.getAttribute("pdl");
                    ...
                    <p style="color: red;">This agent is currently not handling any property.</p>
