...
<div class="login-right">
		...
		<div class="login-top">
				...
				<div class="form-info">
					<form name="registrationfrom" action="reg_serv_agent">
            ...
            City : <select name="city" id="cityid" onchange="getareas();">
               ...
               Area:  <select name="area" id="areaid">
                <option>Select</option>
                                                ...
                                                <input name="addrss" type="text"   placeholder="Address Line 1" required="" >
                                                <input name="addrss2" type="text" placeholder="Address Line 2" required="" >
                                              
                                             
                                                <input name="num" type="text" placeholder="Phone Number" required="">
