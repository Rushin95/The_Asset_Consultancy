...
<div class="buy-sin-single">
			<div class="col-sm-5 middle-side immediate">
						...
						<div class="   right-side">
							 <a href="contact.jsp" class="hvr-sweep-to-right more" >Contact Builder</a>     
					 </div>
					</div>
					...
					<a href="property.jsp" class="hvr-sweep-to-right more">Add a New Property</a>
					</div>
		...
		<div class="col-md-3">
			<div class="single-box-right right-immediate">
				...
				<div class="single-box-img ">
					<div class="box-img">
						<a href="single.jsp"><img class="img-responsive" src="images/sl.jpg" alt=""></a>
					</div>
					<div class="box-text">
						<p><a href="single.jsp">Lorem ipsum dolor sit amet</a></p>
						<a href="single.jsp" class="in-box">More Info</a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="single-box-img">
					<div class="box-img">
						<a href="single.jsp"><img class="img-responsive" src="images/sl1.jpg" alt=""></a>
					</div>
					<div class="box-text">
						<p><a href="single.jsp">Lorem ipsum dolor sit amet</a></p>
						<a href="single.jsp" class="in-box">More Info</a>
				...
				<div class="single-box-img">
					<div class="box-img">
						<a href="single.jsp"><img class="img-responsive" src="images/sl2.jpg" alt=""></a>
					</div>
					<div class="box-text">
						<p><a href="single.jsp">Lorem ipsum dolor sit amet</a></p>
						<a href="single.jsp" class="in-box">More Info</a>
				...
				<div class="single-box-img">
					<div class="box-img">
						<a href="single.jsp"><img class="img-responsive" src="images/sl3.jpg" alt=""></a>
					</div>
					<div class="box-text">
						<p><a href="single.jsp">Lorem ipsum dolor sit amet</a></p>
						<a href="single.jsp" class="in-box">More Info</a>
				...
				<div class="single-box-img">
					<div class="box-img">
						<a href="single.jsp"><img class="img-responsive" src="images/sl4.jpg" alt=""></a>
					</div>
					<div class="box-text">
						<p><a href="single.jsp">Lorem ipsum dolor sit amet</a></p>
						<a href="single.jsp" class="in-box">More Info</a>
