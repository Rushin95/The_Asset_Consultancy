...
<html>
<head>
<title>The Asset Consultancy A Real Estate Flat Bootstarp Resposive Website Template | Blog_Single :: w3layouts</title>
		...
		<div class="blog-list">
		 ...
		 <div class="blog-list1">
			...
			<div class="blog-list-top">
				<div class="blog-img">
					<a href="blog_single.jsp"><img class="img-responsive" src="images/bo.jpg" alt="">
				</div>
				<div class="blog-text">
			...
			<div class="blog-list-top">
				<div class="blog-img">
					<a href="blog_single.jsp"><img class="img-responsive" src="images/bo1.jpg" alt=""></a>
				</div>
				<div class="blog-text">
					<p ><a href="blog_single.jsp">Lorem ipsum dolor sit amet, consectetuer</a></p>
					<span class="link">
						Feb 14, 2015
						<a href="#">
							<i class="glyphicon glyphicon-heart"> </i>
			...
			<div class="blog-list-top">
				<div class="blog-img">
					<a href="blog_single.jsp"><img class="img-responsive" src="images/bo2.jpg" alt=""></a>
				</div>
				<div class="blog-text">
					<p ><a href="blog_single.jsp">Lorem ipsum dolor sit amet, consectetuer</a></p>
					<span class="link">
			...
			<div class="blog-list-top">
				<div class="blog-img">
					<a href="blog_single.jsp"><img class="img-responsive" src="images/bo3.jpg" alt=""></a>
				</div>
				<div class="blog-text">
					<p ><a href="blog_single.jsp">Lorem ipsum dolor sit amet, consectetuer</a></p>
					<span class="link">
			...
			<div class="blog-list-top">
				<div class="blog-img">
					<a href="blog_single.jsp"><img class="img-responsive" src="images/bo4.jpg" alt=""></a>
				</div>
				<div class="blog-text">
					<p ><a href="blog_single.jsp">Lorem ipsum dolor sit amet, consectetuer</a></p>
					<span class="link">
